...
| # | Критерий | Проверка |
|---|----------|----------|
| 1 | Documenter MCP block live **или** org migration started | [#51](https://github.com/dkanster/samotpravil-api-mcp/issues/51) / [#65](https://github.com/dkanster/samotpravil-api-mcp/issues/65) |
