...
echo "# Variant C (org): close #64 — see docs/REPO_NAMING.md"
echo "gh pr close 64 --comment 'Superseded by org migration path (variant C) — see docs/REPO_NAMING.md and issue #65.'"
